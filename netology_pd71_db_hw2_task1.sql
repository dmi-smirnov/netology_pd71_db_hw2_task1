...
CREATE TABLE IF NOT EXISTS musical_album_artist (
  ...
  CONSTRAINT pk_musical_album_artist PRIMARY KEY (musical_album_id, musical_artist_id)
);
...
CREATE TABLE IF NOT EXISTS musical_artist_genre (
  ...
  CONSTRAINT pk_musical_artist_genre PRIMARY KEY (musical_artist_id, musical_genre_id)
);
...
CREATE TABLE IF NOT EXISTS musical_track_collection (
  ...
  CONSTRAINT pk_musical_track_collection PRIMARY KEY (musical_track_id, music_collection_id)
);